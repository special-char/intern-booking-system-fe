...
type FormValues = z.infer<typeof installBundleFormSchema>;
...
export default function InstallBundleForm() {
  ...
  const handleServiceUpdate = async (
    ...
    const serviceData = {
      ...
      service: "Tires & Install" as ServiceType,
  ...
  async function submitFormValues(values: FormValues) {
    ...
    try {
      ...
      if (results.added && results.updated) {
        toast({ title: "Tires & Install added and updated successfully" });
      } else if (results.added) {
        toast({ title: "Tires & Install added successfully" });
