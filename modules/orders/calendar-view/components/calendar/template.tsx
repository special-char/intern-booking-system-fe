...
export async function OrdersCalendarTemplate({ date }: OrdersCalendarTemplateProps) {
  const ordersCalendar: OrdersCalendarType | null = await getOrdersCalendar({ date });
